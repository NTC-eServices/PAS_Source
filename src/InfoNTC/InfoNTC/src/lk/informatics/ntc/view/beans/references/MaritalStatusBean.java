...
@ManagedBean(name = "maritalStatusBean")
@ViewScoped
public class MaritalStatusBean extends CodeDescriptionTemplateBean {

	private static final long serialVersionUID = -5195585990103169578L;
	
	private String TABLE_NAME="nt_r_marital_status";
	private String HEADER_LABLE="marital_status.function.name";
