...
@ManagedBean(name = "employeeStatusBean")
@ViewScoped
public class EmployeeStatusBean extends CodeDescriptionTemplateBean {

	private static final long serialVersionUID = -5195585990103169578L;
	
	private String TABLE_NAME="nt_r_emp_status";
	private String HEADER_LABLE="employee.status.function.name";
