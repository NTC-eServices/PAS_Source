...
@ViewScoped
public class ActivityBean extends CodeDescriptionTemplateBean {

	private static final long serialVersionUID = -5195585990103169578L;
	
	private String TABLE_NAME="nt_r_activity";
	private String HEADER_LABLE="activity.function.name";
