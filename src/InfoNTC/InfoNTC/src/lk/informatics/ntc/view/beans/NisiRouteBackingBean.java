...
@ManagedBean(name = "nisiRouteBackingBean")
@ViewScoped

public class NisiRouteBackingBean {
	...
	public void LoadValues() {
		...
		setRouteList(adminService.getNisiRouteDetailsbyLoginUser(sessionBackingBean.loginUser));
	}
