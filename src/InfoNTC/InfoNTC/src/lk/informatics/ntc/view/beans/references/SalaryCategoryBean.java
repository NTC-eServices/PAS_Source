...
@ManagedBean(name = "salaryCategoryBean")
@ViewScoped
public class SalaryCategoryBean extends CodeDescriptionTemplateBean {

	private static final long serialVersionUID = -5195585990103169578L;

	private String TABLE_NAME = "NT_R_SALARY_CAT";
	private String HEADER_LABLE = "salary.category.function.name";
