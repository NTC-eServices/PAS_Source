...
@ViewScoped
public class DesignationBean extends CodeDescriptionTemplateBean {

	private static final long serialVersionUID = -5195585990103169578L;
	
	private String TABLE_NAME="nt_r_designation";
	private String HEADER_LABLE="designation.function.name";
