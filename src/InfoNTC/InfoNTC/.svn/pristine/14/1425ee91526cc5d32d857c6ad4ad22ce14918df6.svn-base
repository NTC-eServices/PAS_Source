...
@ManagedBean(name = "carderTypeBean")
@ViewScoped
public class CarderTypeBean extends CodeDescriptionTemplateBean {

	private static final long serialVersionUID = -5195585990103169578L;
	
	private String TABLE_NAME="nt_r_emp_carder";
	private String HEADER_LABLE="carder.type.function.name";
