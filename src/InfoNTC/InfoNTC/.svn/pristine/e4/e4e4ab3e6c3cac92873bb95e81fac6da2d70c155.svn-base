...
@ManagedBean(name = "departmentTypeBean")
@ViewScoped
public class DepartmentTypeBean extends CodeDescriptionTemplateBean {

	private static final long serialVersionUID = -5195585990103169578L;
	
	private String TABLE_NAME="NT_R_DEPARTMENT";
	private String HEADER_LABLE="department.type.function.name";
