...
PrimeFaces.widget.Omega = PrimeFaces.widget.BaseWidget.extend({
    ...
    saveMenuState: function() {
        $.cookie('iil_expandeditems', this.expandedMenuitems.join(','), {path: '/'});
    },
    
    clearMenuState: function() {
        $.removeCookie('iil_expandeditems', {path: '/'});
    },
    
    saveProfileMenuState: function() {
        $.cookie('iil_profile_expanded', "1", {path: '/'});
    },
    
    clearProfileMenuState: function() {
        $.removeCookie('iil_profile_expanded', {path: '/'});
    },
    
    restoreMenuState: function() {
        var menucookie = $.cookie('iil_expandeditems');
        if (menucookie) {
        ...
        var profileMenuCookie = $.cookie('iil_profile_expanded');
