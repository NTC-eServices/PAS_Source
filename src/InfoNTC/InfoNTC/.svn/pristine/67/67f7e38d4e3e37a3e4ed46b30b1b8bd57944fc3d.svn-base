...
@ManagedBean(name = "viewrouteBackingBean")
@ViewScoped

public class ViewRouteBackingBean {
	...
	public void LoadValues() {
		...
		setRouteList(adminService.getRouteDetails());
	}

	public void searchRoute() {
		routeList = adminService.getRouteDetailsByRouteNo(reqRouteNo);
	}
