...
@ViewScoped
@ManagedBean(name = "editViewManageCourtCaseNBackingBean")

public class EditViewManageCourtCaseNBackingBean {
	...
	public void init() {
		...
		loadValus();
		courtlaseList = manageCourtCaseService.getcourtcaseListN("E");
		if (createMode == true) {
			disabledSaved = true;
	...
	public void loadValus() {
		vehicleNoList = manageCourtCaseService.getAllVehicleN();
		permitNoList = manageCourtCaseService.getAllPermitN();
