...
@ManagedBean(name = "titleBean")
@ViewScoped
public class TitleBean extends CodeDescriptionTemplateBean {

	private static final long serialVersionUID = -5195585990103169578L;
	
	private String TABLE_NAME="NT_R_TITLE";
	private String HEADER_LABLE="title.type.function.name";
