...
@ManagedBean(name = "chargeTypeBean")
@ViewScoped
public class ChargeTypeBean extends CodeDescriptionTemplateBean {

	private static final long serialVersionUID = -5195585990103169578L;
	
	private String TABLE_NAME="nt_r_charge_type";
	private String HEADER_LABLE="charge.type.function.name";
