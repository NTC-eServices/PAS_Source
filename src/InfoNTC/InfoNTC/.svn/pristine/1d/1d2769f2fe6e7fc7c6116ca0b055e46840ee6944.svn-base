...
@ManagedBean(name = "qualificationsBean")
@ViewScoped
public class QualificationsBean extends CodeDescriptionTemplateBean {

	private static final long serialVersionUID = -5195585990103169578L;
	
	private String TABLE_NAME="nt_r_qualification";
	private String HEADER_LABLE="qualification.type.function.name";
