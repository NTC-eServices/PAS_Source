...
@ViewScoped
public class DocumentTypeBean extends CodeDescriptionTemplateBean {

	private static final long serialVersionUID = -5195585990103169578L;
	
	private String TABLE_NAME="nt_r_document_type";
	private String HEADER_LABLE="document.type.function.name";
