...
@ManagedBean(name = "accidentTypeBean")
@ViewScoped
public class AccidentTypeBean extends CodeDescriptionTemplateBean {

	private static final long serialVersionUID = -5195585990103169578L;
	
	private String TABLE_NAME="nt_r_accident_type";
	private String HEADER_LABLE="accident.type.function.name";
