...
@ManagedBean(name = "editHAPermitHolderInfoBean")
@ViewScoped
public class editHAPermitHolderInfoBackingBean implements Serializable {
	...
	private void loadValues() {
		drpdRequestNoList = sisuSariyaService.getRequesNoDropDownNew();
	...
	public void onRequestStartDateChange(SelectEvent event) throws ParseException {
		...
		if (sisuSeriyaDTO.getRequestStartDateString() != null && !sisuSeriyaDTO.getRequestStartDateString().isEmpty()
			...
			drpdRequestNoList = sisuSariyaService.drpdRequestNoListNew(sisuSeriyaDTO);
		}
	}
	...
	public void onSltbChange() {
		...
		if (sltb) {
			sisuSeriyaDTO.setPermitNo(null);
	...
	public void btnSearch() {
		...
		if (sisuSeriyaDTO.getRequestNo() != null && !sisuSeriyaDTO.getRequestNo().isEmpty()
			...
			sisuSeriyaDTO = sisuSariyaService.retrieveSchoolInfoFromRequestNew(sisuSeriyaDTO);
														...
														if (sisuSeriyaDTO.getProvinceCode() != null
															...
															if (sisuSeriyaDTO.getLanguageCode().equals("S")) {
																...
																if (sisuSeriyaDTO.getAddressOneSin() != null
																		&& !sisuSeriyaDTO.getAddressOneSin().isEmpty()
																	...
																	if (sisuSeriyaDTO.getCitySin() != null
																		...
																		if (edit) {
																			if (sisuSeriyaDTO
																					.getServiceStartDateObj() != null
																					&& sisuSeriyaDTO
																							.getServiceEndDateObj() != null) {
																				validateDateRange();
																			} else {
																				if (sisuSeriyaDTO
																					...
																					if (sisuSariyaService
																							.updateServiceInformationByServiceRefNoEdit(
																									sisuSeriyaDTO,
																					...
																					errorMsg = "Service Reference No is empty. Select application from the grid. ";
																			...
																			// if((sisuSeriyaDTO.getServiceStartDateObj().after(sisuSeriyaDTO.getServiceEndDateObj()))
																			// ||
																			// ((sisuSeriyaDTO.getServiceEndDateObj().before(sisuSeriyaDTO.getServiceStartDateObj()))))
																			// {
																			// errorMsg
																			// =
																			// "Service
																...
																if (sisuSeriyaDTO.getAddressOneTamil() != null
																		&& !sisuSeriyaDTO.getAddressOneTamil().isEmpty()
																		&& !sisuSeriyaDTO.getAddressOneTamil()
																				.equalsIgnoreCase("")) {

																	if (sisuSeriyaDTO.getCityTamil() != null
																			&& !sisuSeriyaDTO.getCityTamil().isEmpty()
																...
																if (edit) {
																	 ...
																	 * sisuSeriyaDTO
																	 * .
																	 * getServiceStartDateObj
																	 * ().after(
																	 * sisuSeriyaDTO
																	 * .
																	 * getServiceEndDateObj
																	 * ())) ||
																	 * ((
																	 * sisuSeriyaDTO
																	 * .
																	 ...
																	 * errorMsg
																	 * =
																	 * "Service start date should be less than or equal to service end date. "
																	 * ;
																	 * RequestContext
																	 * .
																	 * getCurrentInstance
	...
	public void btnTab01Update() {
		...
		if (sisuSariyaService.updateServiceInformationByServiceRefNoEdit(sisuSeriyaDTO, sessionBackingBean.loginUser)) {
		}
	...
	public void getServiceInformation(String serviceRefNo) {
		...
		// drpdBankBranchList= surveyService.getBranchListDropDown();
	...
	public void editServiceInformation(String serviceRefNo) {
		...
		if (renderEdit) {
			...
			this.sisuSeriyaDTO = sisuSariyaService.retrieveSchoolInfoFromRequestNew(sisuSeriyaDTO);
		}
	...
	public void validateDateRange() {
		if ((sisuSeriyaDTO.getServiceStartDateObj().after(sisuSeriyaDTO.getServiceEndDateObj()))
				|| ((sisuSeriyaDTO.getServiceEndDateObj().before(sisuSeriyaDTO.getServiceStartDateObj())))) {
			errorMsg = "Service start date should be less than or equal to service end date. ";
			RequestContext.getCurrentInstance().update("frm-serviceInformation");
			RequestContext.getCurrentInstance().execute("PF('requiredField').show()");
		} else {
			if (sisuSeriyaDTO.getServiceRefNo() != null && !sisuSeriyaDTO.getServiceRefNo().isEmpty()
				...
				if (sisuSariyaService.updateServiceInformationByServiceRefNoEdit(sisuSeriyaDTO,
						sessionBackingBean.loginUser)) {
						...
						if (sisuSeriyaDTO.getSchoolProvinceCode() != null
							...
							if (sisuSeriyaDTO.getLanguageCode().equals("S")) {
								...
								if (sisuSeriyaDTO.getSchoolAdrressOneSin() != null
										...
										&& !sisuSeriyaDTO.getSchoolAdrressOneSin().equalsIgnoreCase("")) {

									if (sisuSeriyaDTO.getSchoolCitySin() != null
											&& !sisuSeriyaDTO.getSchoolCitySin().isEmpty()
											&& !sisuSeriyaDTO.getSchoolCitySin().equalsIgnoreCase("")) {

										/**
										 * update
										 **/
										if (sisuSariyaService.updateSchoolInformationByServiceRefNoNew(sisuSeriyaDTO,
												sessionBackingBean.loginUser)) {
											RequestContext.getCurrentInstance().execute("PF('successMessage').show()");
										} else {
											errorMsg = "Could not update data successfully";
								...
								if (sisuSeriyaDTO.getSchoolAddressOneTamil() != null
										...
										&& !sisuSeriyaDTO.getSchoolAddressOneTamil().equalsIgnoreCase("")) {

									if (sisuSeriyaDTO.getSchoolCityTamil() != null
											&& !sisuSeriyaDTO.getSchoolCityTamil().isEmpty()
											&& !sisuSeriyaDTO.getSchoolCityTamil().equalsIgnoreCase("")) {
	...
	public void btnTab03Save() {
		...
		boolean added = sisuSariyaService.insertBankDetailsNew(sisuSeriyaDTO, sessionBackingBean.loginUser);

		if (added) {

			if (!commonService.checkTaskDetailsInSubsidyByServiceRefNo(sisuSeriyaDTO.getServiceRefNo(), "SS005", "C")) {
				commonService.updateTaskStatusCompletedSubsidyTaskTabel(null, null, sisuSeriyaDTO.getServiceRefNo(),
						"SS005", "C");
			}
			RequestContext.getCurrentInstance().execute("PF('successMessage').show()");
		} else {
			errorMsg = "Bank details didn't addded";
			RequestContext.getCurrentInstance().update("frm-serviceInformation");
			RequestContext.getCurrentInstance().execute("PF('requiredField').show()");
		}
	}
