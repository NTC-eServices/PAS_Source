...
@ManagedBean(name = "responsibilitiesBean")
@ViewScoped
public class ResponsibilitiesBean extends CodeDescriptionTemplateBean {

	private static final long serialVersionUID = -5195585990103169578L;
	
	private String TABLE_NAME="nt_r_responsibilities";
