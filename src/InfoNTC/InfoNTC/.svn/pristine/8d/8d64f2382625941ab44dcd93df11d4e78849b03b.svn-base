...
@ManagedBean(name = "serviceType")
@ViewScoped
public class ServiceType extends CodeDescriptionTemplateBean {

	private static final long serialVersionUID = -5195585990103169578L;
	
	private String TABLE_NAME="nt_r_service_types";
	private String HEADER_LABLE="service.type.function.name";
