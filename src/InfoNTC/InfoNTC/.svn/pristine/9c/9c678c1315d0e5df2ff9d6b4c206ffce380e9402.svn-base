...
@ManagedBean(name = "subUnitBean")
@ViewScoped
public class SubUnitBean extends CodeDescriptionTemplateBean {

	private static final long serialVersionUID = -5195585990103169578L;

	private String TABLE_NAME = "NT_R_SUB_UNIT";
	private String HEADER_LABLE = "sub.unit.function.name";
