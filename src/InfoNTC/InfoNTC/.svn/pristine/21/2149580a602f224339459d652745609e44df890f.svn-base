...
@ViewScoped
public class FunctionsBean extends CodeDescriptionTemplateBean {

	private static final long serialVersionUID = -5195585990103169578L;
	
	private String TABLE_NAME="nt_r_function";
	private String HEADER_LABLE="function.type.function.name";
