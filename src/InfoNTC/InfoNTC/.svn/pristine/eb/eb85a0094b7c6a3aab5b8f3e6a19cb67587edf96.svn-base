...
@ViewScoped
public class DistrictBean extends CodeDescriptionTemplateBean {

	private static final long serialVersionUID = -5195585990103169578L;
	
	private String TABLE_NAME="nt_r_district";
	private String HEADER_LABLE="district.function.name";
