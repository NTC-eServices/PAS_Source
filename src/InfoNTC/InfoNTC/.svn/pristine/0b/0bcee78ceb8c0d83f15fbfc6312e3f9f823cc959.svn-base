...
@ManagedBean(name = "viewVehicleInspectionBean")
@ViewScoped
public class ViewVehicleInspectionBean {
	...
	public void searchDetails() {
		...
		if (!selectedApplicationNo.isEmpty() && selectedApplicationNo != null && !selectedApplicationNo.equals("")
			...
			dataList = inspectionActionPointService.getAllRecordsForViewInspections(selectedApplicationNo,
					selectedVehicleNo);
			...
			dataList = inspectionActionPointService.getAllRecordsForBothViewInspection(selectedApplicationNo,
					selectedVehicleNo);
